...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KEYMAP(
		...
		KC_LCTL, KC_LGUI, KC_LALT,         KC_SPC, MO(1),   KC_LEFT, KC_DOWN, KC_RGHT, KC_DEL,  KC_12,  KC_BSLS, KC_BSPC),
	...
	KEYMAP(
		...
		KC_TRNS, KC_TRNS, KC_TRNS,          KC_TRNS, KC_TRNS, KC_HO, KC_PGDOWN, KC_END, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
